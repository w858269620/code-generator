        ...
        if (!CollectionUtils.isEmpty(all)) {
            ...
            if (!CollectionUtils.isEmpty(metaDatabaseDdlHistories)) {
                metaDatabaseDdlHistories.forEach(r -> {
                    ...
                    String createDdl = MataDatabaseUtil.resetAutoIncrement(r.getTableDdl());
                    String createTable = MataDatabaseUtil.resetAutoIncrement(r.getTableCreate());
                    metaDatabaseDdlResponse.setReplacement(request.getReplacement());
                    metaDatabaseDdlResponse.setCreateDdl(createDdl);
                    metaDatabaseDdlResponse.setCreateTable(createTable);
