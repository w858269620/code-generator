package cn.iba8.module.generator.common.jsontojava.converter.builder;
...
//            addGettersAndSetters(propertyName, declareName);
    ...
    private void declareClass(String className, String packagename) {
        ...
        stringBuilder
                ...
                .append(NEW_LINE)
                .append("@Data") //import statements
                .append(NEW_LINE)
                .append("public class ").append(this.className).append(SPACE).append("implements").append(SPACE).append("Serializable").append(SPACE)
                .append(BLOCK_OPEN)
                .append(DOUBLE_NEW_LINE)
                .append("%s") //properties
                .append(NEW_LINE)
